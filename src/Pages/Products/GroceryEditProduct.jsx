    ...
    <section className="ga-page">
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .ga-progress-panel { min-width: 200px; }
        ...
        <div className="ga-header ga-header-row">
          ...
          {!loadingMeta && shop && (
            <div className="ga-progress-panel">
              ...
              {isDirty && (
                <span className="ga-dirty-pill"><span className="ga-dirty-dot" /> Unsaved changes</span>
              )}
              {isDirty && !loadingMeta && (
                <button type="button" className="ga-btn-ghost ga-discard-btn" onClick={discardChanges} disabled={isLoading}>
                  <FaUndo size={11} /> Discard changes
                </button>
              )}
            </div>
          )}
