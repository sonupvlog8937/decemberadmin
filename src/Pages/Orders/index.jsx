...
.ao-panel-cell {
  /* This will span all visible columns */
}
.ao-panel {
  background: #f7f7fb;
...
@media (max-width: 768px) {
  ...
  .ao-tbl thead th:nth-child(3), /* Payment */
  .ao-tbl tbody td:nth-child(3) {
    display: none;
  }
  
  .ao-tbl thead th:nth-child(5), /* Address */
  .ao-tbl tbody td:nth-child(5) {
    display: none;
  }
  
  .ao-tbl thead th:nth-child(8), /* Date */
  .ao-tbl tbody td:nth-child(8) {
    display: none;
  }
  
  /* Keep important columns: Expand, Order ID, Customer, Distance, Amount, Status, Action */
  .ao-tbl th,
  .ao-tbl td {
    padding: 10px 8px;
    font-size: 12px;
  ...
  /* Distance cell - Keep visible and responsive */
  .ao-tbl thead th:nth-child(6), /* Distance column */
  .ao-tbl tbody td:nth-child(6) {
    display: table-cell !important;
    min-width: 90px;
  }
  
  /* Make distance badge smaller on mobile */
  .ao-tbl tbody td:nth-child(6) > div {
    gap: 3px !important;
  }
  
  .ao-tbl tbody td:nth-child(6) > div > span {
    font-size: 11px !important;
    padding: 3px 7px !important;
    white-space: nowrap !important;
  }
  
  .ao-tbl tbody td:nth-child(6) a {
  ...
  .ao-oid-full {
    display: none; /* Hide full ID on mobile */
  }
  ...
  .ao-tbl tbody td:last-child > div {
    flex-direction: column;
    gap: 4px;
  }
  ...
  .ao-panel-row > td {
    /* Update colspan for mobile (fewer visible columns) */
    display: table-cell;
  }
  
  /* Distance info card in expanded panel - responsive */
  .ao-panel .ao-panel-hdr + div {
    padding: 10px 12px;
  }
  
  .ao-panel .ao-panel-hdr + div > div:first-child {
    width: 32px !important;
    height: 32px !important;
    font-size: 16px !important;
  }
  
  .ao-panel .ao-panel-hdr + div > div:last-child > div:first-child {
    font-size: 10px !important;
  }
  
  .ao-panel .ao-panel-hdr + div > div:last-child > div:nth-child(2) {
    font-size: 16px !important;
    flex-wrap: wrap;
  }
  
  .ao-panel .ao-panel-hdr + div > div:last-child > div:nth-child(2) a {
    font-size: 10px !important;
    padding: 3px 8px !important;
  }
  
  /* Product cards in panel */
  .ao-prod-card {
    flex-direction: column;
...
@media (max-width: 480px) {
  ...
  /* Hide expand button text, keep icon only */
  .ao-xbtn {
    width: 24px;
    height: 24px;
    font-size: 12px;
  ...
  /* Customer column - even more compact */
  .ao-cust-name {
    font-size: 11px;
    max-width: 100px;
    overflow: hidden;
  ...
  /* Distance - smaller but still visible */
  .ao-tbl tbody td:nth-child(6) > div > span {
    font-size: 10px !important;
  ...
  .ao-tbl tbody td:nth-child(6) a {
    display: none; /* Hide navigate button on very small screens */
  }
  
  /* Status select - smaller */
  .ao-status-sel .MuiSelect-select {
  ...
  /* Distance card in panel - compact */
  .ao-panel .ao-panel-hdr + div {
    padding: 8px 10px;
  }
                    ...
                    <React.Fragment key={order._id}>
                      ...
                      {isOpen && (
                        <tr className="ao-panel-row">
                          <td colSpan={10} className="ao-panel-cell">
